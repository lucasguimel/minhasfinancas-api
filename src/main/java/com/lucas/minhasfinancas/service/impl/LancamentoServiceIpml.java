...
import com.lucas.minhasfinancas.service.LancamentoService;
	...
	@Service
public class LancamentoServiceIpml implements LancamentoService {
		
		private LancamentoRepository repository;
		
		public void LancamentoServiceImpl(LancamentoRepository repository) {
	...
	public void validar(Lancamento lancamento) {
		...
		if(lancamento.getTipo() == null) {
			throw new RegraNegocioException("Informe um Tipo de Laçamento.");
		}
	}
